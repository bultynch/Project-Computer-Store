  ...
  return (
    <div className='pt-6 pb-9 px-4 md:px-10 dark:bg-neutral-800'>
      ...
      <div className='flex flex-wrap justify-between'>
        ...
        <div className='h-128 w-full sm:w-60 md:w-96 flex flex-col justify-end rounded-2xl bg-imagen-servicio-1 bg-cover bg-no-repeat hover:scale-105 transition-transform shadow-sm border'>
        ...
        <div className='h-128 w-full sm:w-60 md:w-96 flex flex-col justify-end rounded-2xl bg-imagen-servicio-2 bg-cover bg-no-repeat hover:scale-105 transition-transform shadow-sm border'>
          <div className='h-52 p-6 bg-[#00000080] rounded-b-2xl'>
        ...
        <div className='h-128 w-full sm:w-60 md:w-96 flex flex-col justify-end rounded-2xl bg-imagen-servicio-3 bg-cover bg-no-repeat hover:scale-105 transition-transform shadow-sm border'>
          <div className='h-52 p-6 bg-[#00000080] rounded-b-2xl'>
        ...
        <div className='h-128 w-full sm:w-60 md:w-96 flex flex-col justify-end rounded-2xl bg-imagen-servicio-4 bg-cover bg-no-repeat hover:scale-105 transition-transform shadow-sm border'>
          <div className='h-52 p-6 bg-[#00000080] rounded-b-2xl'>
