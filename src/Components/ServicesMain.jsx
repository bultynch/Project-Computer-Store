  ...
  return (
    <div className='pt-6 pb-9 px-40'>
      ...
      <div className='px-10 flex items-center justify-center '>
        ...
        <div className='h-128 w-80 flex flex-col justify-end rounded bg-imagen-servicio-1 bg-cover bg-no-repeat hover:scale-105 transition-transform'>
          <div className='h-60 py-8 bg-[#00000080] rounded-b'>
        ...
        <div className='mx-6 h-144 w-96 flex flex-col justify-end rounded bg-imagen-servicio-2 bg-cover bg-no-repeat hover:scale-105 transition-transform'>
          <div className='h-60 py-8 bg-[#00000080] rounded-b'>
        ...
        <div className='h-128 w-80 flex flex-col justify-end rounded bg-imagen-servicio-3 bg-cover bg-no-repeat hover:scale-105 transition-transform'>
          <div className='h-60 py-8 bg-[#00000080] rounded-b'>
