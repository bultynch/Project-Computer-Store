...
function Servicios() {
  return (
    <div className='pt-6 pb-9 px-4 md:px-10'>

      <h1 className='flex items-center justify-start text-3xl md:text-4xl'><strong>Nuestros servicios</strong></h1>    
      <div className="divider"></div> 

      <div className='flex flex-wrap justify-between'>

        <div className='h-128 w-full sm:w-60 md:w-96 flex flex-col justify-end rounded-2xl bg-imagen-servicio-1 bg-cover bg-no-repeat hover:scale-105 transition-transform'>
