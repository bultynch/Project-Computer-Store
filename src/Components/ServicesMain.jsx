  ...
  return (
    <div className='py-10 px-2 lg:px-10 xl:px-20 dark:bg-neutral-800'>
      ...
      <div className='flex flex-wrap justify-center'>
        ...
        <div className='mb-2 w-96 h-128 flex flex-col justify-end rounded-2xl shadow-sm border bg-imagen-servicio-1 bg-cover bg-no-repeat transition-transform sm:hover:scale-105'>
        ...
        <div className='mb-2 sm:mb-0 w-96 h-128 flex flex-col justify-end rounded-2xl shadow-sm border bg-imagen-servicio-2 bg-cover bg-no-repeat transition-transform sm:hover:scale-105'>
        ...
        <div className='mb-2 sm:mb-0 w-96 h-128 flex flex-col justify-end rounded-2xl shadow-sm border bg-imagen-servicio-3 bg-cover bg-no-repeat transition-transform sm:hover:scale-105'>
        ...
        <div className='w-96 h-128 flex flex-col justify-end rounded-2xl shadow-sm border bg-imagen-servicio-4 bg-cover bg-no-repeat transition-transform sm:hover:scale-105'>
