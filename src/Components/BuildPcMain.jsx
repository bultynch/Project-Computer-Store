...
function BuildPcMain() {
  return (
    <div className='w-full h-96 md:h-128 lg:h-160 relative flex items-center justify-center bg-cover bg-no-repeat font-bold' style={{backgroundImage: `url(${process.env.PUBLIC_URL + '/bg-nintendo2.jpg'})`}}>
