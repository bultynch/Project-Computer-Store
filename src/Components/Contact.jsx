...
function Contact() {
  ...
  return (
    <div className='flex flex-col items-center justify-between md:flex-row bg-violet-50 dark:bg-neutral-700'>
      ...
      <form onSubmit={handleSubmit} className='w-full max-w-lg flex flex-col justify-center '>
        ...
        <div className='text-center text-md text-gray-500'>
          <button type="submit" className='mt-2 p-4 w-full bg-cc1 border border-cc1 text-white rounded-lg shadow-sm hover:bg-white hover:text-cc1 hover:border-cc1'>Enviar</button>
        </div>
