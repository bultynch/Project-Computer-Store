...
function NavigationBar() {
  return (
    <div className="navbar bg-base-100 py-4 border-b shadowm-sm">

      <div className="navbar-start">

        <label className="swap swap-rotate btn btn-ghost btn-circle hover:bg-gray-300">
      ...
      <div className="navbar-center">
        <Link to='/' className="btn btn-ghost text-xl hover:rounded-lg">Project Computer Store</Link>
      </div>
