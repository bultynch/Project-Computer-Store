...
function BuildPcPageProcessor2() {
  return (
    <div className='flex flex-col min-h-screen'>
      ...
      <div className='px-80 py-4 flex flex-col bg-violet-50'>

        <div className='flex items-center justify-between'>
          <Link to='/buildPc' className="w-44 h-14 mb-2 px-4 py-2 flex items-center bg-white border rounded-lg text-lg shadow-sm hover:bg-gray-100 hover:shadow-none"><FaArrowLeft className='w-5 h-5 mr-2'/>Paso anterior</Link>
          <Link to='/mother1' className="w-44 h-14 mb-2 px-2.5 py-2 flex items-center bg-white border rounded-lg text-lg shadow-sm hover:bg-gray-100 hover:shadow-none">Siguiente paso<FaArrowRight className='w-5 h-5 ml-1'/></Link>
        </div>
        ...
        <div className='h-160 flex items-start justify-between py-2'>
          ...
          <div className='flex flex-col items-center'>
            ...
            <div className='ml-2 mb-2 bg-white rounded-lg'>
            ...
            <div className='ml-2 my-2 bg-white rounded-lg'>
