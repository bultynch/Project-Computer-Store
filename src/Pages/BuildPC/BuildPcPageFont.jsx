    ...
    <div className='flex flex-col min-h-screen'>
      ...
      <div className='px-80 py-4 flex flex-col bg-gray-50'>
        ...
        <div className='flex items-center justify-between'>
          ...
          <Link to='/case' className="w-44 h-14 mb-2 px-2.5 py-2 flex items-center bg-white border rounded-lg text-lg shadow-sm hover:bg-gray-100 hover:shadow-none">Siguiente paso<FaArrowRight className='w-5 h-5 ml-1'/></Link>
        </div>
